...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback,
    ...
    override fun onConnected(p0: Bundle?) {
        ...
        if (mLocation == null) {
            ...
            Toast.makeText(applicationContext, "Waiting for GPS to locate..", Toast.LENGTH_LONG).show()
        }
    }
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        if (latlng != null) {
            ...
            mMap!!.addMarker(MarkerOptions().position(latlng!!).title("Emergency: Vehicle Impact").icon(BitmapDescriptorFactory.fromBitmap(bmp)))
